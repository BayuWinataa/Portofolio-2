...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <ScrambleText>Bayu Winata</ScrambleText>
        <h2 className="text-xl font-bold dark:text-white md:text-4xl">
          Halo, selamat datang!
          <span className="hidden w-12 md:inline-block">
            <Image src={'/wave.gif'} alt="Animasi salam" width={100} height={100} />
          </span>
        </h2>
        <h3 className="text-xl font-bold dark:text-white md:text-3xl">
          Saya seorang{' '}
          <TypeAnimation
            sequence={[
              'Fullstack Developer',
        ...
        <p className="max-w-lg text-center text-sm dark:text-white md:max-w-2xl md:text-left md:text-base">
          Saya adalah <b>Fullstack Developer</b> &{' '}
          <span className="inline-block rotate-3 bg-orange-primary px-2 py-1 font-bold">
            WordPress Developer
          </span>{' '}
          dari Aceh, Indonesia. Saya membangun antarmuka web & mobile yang bersih,
          responsif, dan mengubah ide menjadi pengalaman pengguna yang mulus.
        </p>
        <div className="flex gap-4">
          <button
            aria-label="Lihat Resume Bayu Winata"
          ...
          <a
            role="button"
            aria-label="Pelajari lebih lanjut tentang Bayu Winata"
      ...
      <motion.div className="hidden h-full w-80 cursor-pointer items-center lg:flex">
        <motion.img
          ...
          alt="Bayu Winata — Fullstack Developer dari Aceh, Indonesia"
          width={400}
          height={400}
        />
      </motion.div>
